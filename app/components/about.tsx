...
const About: React.FC = () => {
    ...
    return (
        <div className=" ml-10">
            <h1 id="scrollTargetAbout" className="arbutus-slab-regular text-6xl mb-10 item-center text-white font-md pt-6">About</h1>
            <div className="flex">
            ...
            <div className="flex justify-center mb-3">
                <h1 className="arbutus-slab-regular text-6xl text-white font-md">My Skills</h1>
            </div>
